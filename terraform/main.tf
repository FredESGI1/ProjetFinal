...
resource "ovh_cloud_project_database" "db_eductive18" {
  engine       = "mysql"
  flavor       = "db1-4"
...
resource "ovh_cloud_project_database_user" "eductive18" {
  service_name = ovh_cloud_project_database.db_eductive18.service_name
  engine       = ovh_cloud_project_database.db_eductive18.engine
  name         = "eductive18"
  cluster_id   = ovh_cloud_project_database.db_eductive18.id
}

output "db_username" {
  value = ovh_cloud_project_database_user.eductive18.name
}
  ...
  content  = templatefile("templates/inventory.tmpl",
    {
      ...
      db_hostname  = split("/",split("@",ovh_cloud_project_database.db_eductive18.endpoints[0].uri)[1])[0]
      db_username  = ovh_cloud_project_database_user.eductive18.name
      db_password  = ovh_cloud_project_database_user.eductive18.password
